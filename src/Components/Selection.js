    ...
    if (newItem === false && cart.length < 50) {
        ...
        addItem = (
            <div className="ticket-row add-item-config">
                ...
                <select name="item-name" id="item-name" onChange={setItemName} defaultValue={newItem.itemId}
                ...
                {sidesBox}
                <textarea type="text" id="item-notes" name="item-notes"
    ...
    for (const item of cart) {
        cartDisplay.push(
            <div className="ticket-row cart-row" key={i}>
                ...
                <div className="cart-delete" id={i} onClick={cartDelete}>
